...
# kettle-test Rakefile v7.1.8 - 2026-08-28
...
# rake install                                # Build and install kettle-test-1.0.0.gem in...
# rake install:local                          # Build and install kettle-test-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template kettle-test against itse...
