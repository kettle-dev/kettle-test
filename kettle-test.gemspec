...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.2", ">= 2.2.15")     # ruby >= 2.4
  ...
  # The 'git' gem is optional; kettle-test falls back to shelling out to `git` if it is not present.
