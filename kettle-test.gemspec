...
Gem::Specification.new do |spec|
  ...
  spec.summary = "🍲 A kettle-dev meta tool to streamline testing"
  ...
  # Utilities
  spec.add_dependency("appraisal2", "~> 3.0", ">= 3.0.6")               # ruby >= 1.8.7, for testing against multiple versions of dependencies
  ...
  spec.add_dependency("turbo_tests2", "~> 3.1", ">= 3.1.12")             # ruby >= 2.4.0, shared RSpec helpers for spawned subprocess specs
  ...
  spec.add_development_dependency("kettle-dev", "~> 3.0", ">= 3.0.14")             # ruby >= 2.4
